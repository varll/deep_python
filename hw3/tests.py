...
class TestCustomList(unittest.TestCase):
    ...
    def test_add(self):
        self.assertEqual(self.test_list1 + self.test_list2, [4, 6, 3])
        self.assertEqual(self.test_list1, [1, 2, 3])
        self.assertEqual(self.test_list2, [3, 4])

        self.assertEqual(self.test_list1 + [1], [2, 2, 3])
        self.assertEqual(self.test_list1, [1, 2, 3])

        self.assertEqual([1, 2] + self.test_list1, [2, 4, 3])
        self.assertEqual(self.test_list1, [1, 2, 3])

        self.assertEqual(self.test_list1 + [], [1, 2, 3])
        self.assertEqual(self.test_list1 + self.test_empty_list, [1, 2, 3])

    def test_sub(self):
        self.assertEqual(self.test_list1 - self.test_list2, [-2, -2, 3])
        self.assertEqual(self.test_list1, [1, 2, 3])
        self.assertEqual(self.test_list2, [3, 4])

        self.assertEqual(self.test_list1 - [1], [0, 2, 3])
        self.assertEqual(self.test_list1, [1, 2, 3])

        self.assertEqual([1, 2] - self.test_list1, [0, 0, -3])
        self.assertEqual(self.test_list1, [1, 2, 3])
